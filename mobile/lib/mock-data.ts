...
export const AFRICAN_CITIES: AfricanCity[] = [
  ...
  { slug: 'daloa',       name: 'Daloa',        country: 'Côte d\'Ivoire',         lat: 6.8770,  lng: -6.4502 },
  { slug: 'korhogo',     name: 'Korhogo',      country: 'Côte d\'Ivoire',         lat: 9.4580,  lng: -5.6294 },
  { slug: 'san-pedro',   name: 'San-Pédro',    country: 'Côte d\'Ivoire',         lat: 4.7485,  lng: -6.6363 },
  { slug: 'gagnoa',      name: 'Gagnoa',       country: 'Côte d\'Ivoire',         lat: 6.1319,  lng: -5.9506 },
  { slug: 'man',         name: 'Man',          country: 'Côte d\'Ivoire',         lat: 7.4125,  lng: -7.5538 },
  { slug: 'divo',        name: 'Divo',         country: 'Côte d\'Ivoire',         lat: 5.8390,  lng: -5.3573 },
  { slug: 'anyama',      name: 'Anyama',       country: 'Côte d\'Ivoire',         lat: 5.4946,  lng: -4.0518 },
  { slug: 'abengourou',  name: 'Abengourou',   country: 'Côte d\'Ivoire',         lat: 6.7297,  lng: -3.4964 },
  { slug: 'grand-bassam',name: 'Grand-Bassam', country: 'Côte d\'Ivoire',         lat: 5.2118,  lng: -3.7387 },
  { slug: 'dabou',       name: 'Dabou',        country: 'Côte d\'Ivoire',         lat: 5.3257,  lng: -4.3770 },
  { slug: 'agboville',   name: 'Agboville',    country: 'Côte d\'Ivoire',         lat: 5.9280,  lng: -4.2131 },
  { slug: 'bingerville', name: 'Bingerville',  country: 'Côte d\'Ivoire',         lat: 5.3550,  lng: -3.8854 },
  { slug: 'soubre',      name: 'Soubré',       country: 'Côte d\'Ivoire',         lat: 5.7836,  lng: -6.5931 },
  { slug: 'seguela',     name: 'Séguéla',      country: 'Côte d\'Ivoire',         lat: 7.9611,  lng: -6.6731 },
  { slug: 'odienne',     name: 'Odienné',      country: 'Côte d\'Ivoire',         lat: 9.5092,  lng: -7.5640 },
  { slug: 'ferkessedougou',name: 'Ferkessédougou', country: 'Côte d\'Ivoire',    lat: 9.5928,  lng: -5.1947 },
  { slug: 'bondoukou',   name: 'Bondoukou',    country: 'Côte d\'Ivoire',         lat: 8.0402,  lng: -2.8000 },
  { slug: 'sassandra',   name: 'Sassandra',    country: 'Côte d\'Ivoire',         lat: 4.9500,  lng: -6.0833 },
  { slug: 'adzope',      name: 'Adzopé',       country: 'Côte d\'Ivoire',         lat: 6.1067,  lng: -3.8606 },
  { slug: 'tiassale',    name: 'Tiassalé',     country: 'Côte d\'Ivoire',         lat: 5.8984,  lng: -4.8228 },
  { slug: 'toumodi',     name: 'Toumodi',      country: 'Côte d\'Ivoire',         lat: 6.5524,  lng: -5.0192 },
  { slug: 'issia',       name: 'Issia',        country: 'Côte d\'Ivoire',         lat: 6.4922,  lng: -6.5856 },
  { slug: 'daoukro',     name: 'Daoukro',      country: 'Côte d\'Ivoire',         lat: 7.0586,  lng: -3.9631 },
  { slug: 'aboisso',     name: 'Aboisso',      country: 'Côte d\'Ivoire',         lat: 5.4675,  lng: -3.2072 },
  { slug: 'bouafle',     name: 'Bouaflé',      country: 'Côte d\'Ivoire',         lat: 6.9904,  lng: -5.7442 },
  { slug: 'katiola',     name: 'Katiola',      country: 'Côte d\'Ivoire',         lat: 8.1333,  lng: -5.1000 },
  { slug: 'duekoue',     name: 'Duékoué',      country: 'Côte d\'Ivoire',         lat: 6.7419,  lng: -7.3436 },
  { slug: 'guiglo',      name: 'Guiglo',       country: 'Côte d\'Ivoire',         lat: 6.5439,  lng: -7.4936 },
  { slug: 'oume',        name: 'Oumé',         country: 'Côte d\'Ivoire',         lat: 6.3833,  lng: -5.4167 },
  { slug: 'tingrela',    name: 'Tingréla',     country: 'Côte d\'Ivoire',         lat: 10.4833, lng: -6.4167 },
  ...
  { slug: 'kaolack',     name: 'Kaolack',      country: 'Sénégal',                lat: 14.1592, lng: -16.0729 },
  { slug: 'ziguinchor',  name: 'Ziguinchor',   country: 'Sénégal',                lat: 12.5681, lng: -16.2719 },
  { slug: 'touba',       name: 'Touba',        country: 'Sénégal',                lat: 14.8500, lng: -15.8833 },
  { slug: 'sikasso',     name: 'Sikasso',      country: 'Mali',                   lat: 11.3170, lng: -5.6660 },
  { slug: 'segou',       name: 'Ségou',        country: 'Mali',                   lat: 13.4317, lng: -6.2157 },
  { slug: 'mopti',       name: 'Mopti',        country: 'Mali',                   lat: 14.4843, lng: -4.1796 },
  { slug: 'bobo-dioulasso',name: 'Bobo-Dioulasso', country: 'Burkina Faso',      lat: 11.1771, lng: -4.2979 },
  { slug: 'nzerekore',   name: 'Nzérékoré',    country: 'Guinée',                 lat: 7.7562,  lng: -8.8179 },
  { slug: 'kankan',      name: 'Kankan',       country: 'Guinée',                 lat: 10.3854, lng: -9.3057 },
  { slug: 'ibadan',      name: 'Ibadan',       country: 'Nigéria',                lat: 7.3776,  lng: 3.9470 },
  { slug: 'port-harcourt',name: 'Port Harcourt', country: 'Nigéria',             lat: 4.8156,  lng: 7.0498 },
  { slug: 'benin-city',  name: 'Benin City',   country: 'Nigéria',                lat: 6.3350,  lng: 5.6037 },
  { slug: 'tamale',      name: 'Tamale',       country: 'Ghana',                  lat: 9.4008,  lng: -0.8393 },
  { slug: 'sekondi',     name: 'Sekondi-Takoradi', country: 'Ghana',             lat: 4.9344,  lng: -1.7133 },
  // Afrique Centrale
...
// DB category slug → human tag label (pros' categories come back as slugs).
